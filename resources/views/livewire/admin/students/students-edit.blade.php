    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-2">
                    <div class="form-group">
                        <label class="control-label">{{__("note box")}}</label>
                        <textarea wire:model.defer="user.note" placeholder="{{__("note box")}}"
                               class="form-control @error('user.note') is-invalid @enderror" type="text" rows="4"></textarea>
                        @error('user.note')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <button class="btn btn-outline-secondary" type="button" wire:click="decrementLessonCount">-</button>
                            </div>

                            <input wire:model.defer="user.lesson_add"  placeholder="{{ __("0") }}"
                            class="form-control @error('user.lesson_add') is-invalid @enderror" type="number">


                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" type="button" wire:click="incrementLessonCount">+</button>
                            </div>
                        </div>
                    </div>
