...
class CoachesEdit extends Component
{
    use WithFileUploads;
    ...
    function mount($id)
    {
        $user = User::role('Coach')->findOrFail($id);
    ...
    public function update()
    {
        ...
        $user = User::role('Coach')->findOrFail($this->user['id']);
    ...
    {
        return view('livewire.admin.coaches.coaches-edit')->layout('layouts.admins.app');
    }
